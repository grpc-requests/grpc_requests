...
## [0.1.22](https://github.com/grpc-requests/grpc_requests/releases/tag/v0.1.22) - 2025-06-25

### Added

- Added methods to retrieve a JSON dictionary of a methods request and response descriptors, populated with default field definitions.

### Updates

- Updated version combinations of grpcio and protobuf under test.

### Deprecated

- Deprecating the functions to retrieve "human readable" formatted versions of a methods request and response descriptors.
